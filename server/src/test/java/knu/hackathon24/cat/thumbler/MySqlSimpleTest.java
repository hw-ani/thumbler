...
public class MySqlSimpleTest {
  ...
  public void userInsert() {
    ...
    UserMember userMember1 = new UserMember("hwan", "010-1234-5678", "hwani", "jh1", "hwan", "kakao", "3333", point1);
    ...
    Optional<UserMember> findUserMember_Optional = userMemberRepository.findById(userMember1.getId());
		UserMember findUserMember = findUserMember_Optional.get();
  ...
  public void locationStoreFoodReservation() {
    ...
    Optional<Location> findLocation_Optional = locationRepository.findById(location1.getId());
		Location findLocation = findLocation_Optional.get();
    ...
    Store findStore = findStore_Optional.get();
    ...
    Food findFood = findFood_Optional.get();
    ...
    Reservation findReservation = findReservation_Optional.get();
